...
print("Download UPX")
with urlopen("https://github.com/upx/upx/releases/download/v4.0.2/upx-4.0.2-win64.zip") as r:
	with zipfile.ZipFile(io.BytesIO(r)) as z:
...
with urlopen("https://www.gyan.dev/ffmpeg/builds/ffmpeg-release-essentials.zip") as r:
	with zipfile.ZipFile(io.BytesIO(r)) as z:
		for file in z.infolist():
